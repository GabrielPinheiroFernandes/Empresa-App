...
function EmpDetail({ route }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            if (title) {
                ...
                //formatando o cnpj que vem sem mascara do banco
    ...
    return (
        <View style={style.container}>
            ...
            />
            {data && <ScrollView style={{ width: '100%'}}>       
                        <InputText label='ID Responsável Sócio' value={ID_RESPONSAVEL_SOCIO} readOnly={editable} onChangeText={setID_RESPONSAVEL_SOCIO}/>
                        <InputText label='ID Matriz' value={ID_MATRIZ} readOnly={editable} onChangeText={setID_MATRIZ}/>
                        <InputText label='ID Sindicato Patronal' value={ID_SINDICATO_PATRONAL} readOnly={editable} onChangeText={setID_SINDICATO_PATRONAL}/>
                        <InputText label='ID FPAS' value={ID_FPAS} readOnly={editable} onChangeText={setID_FPAS}/>
                        <InputText label='ID Contador' value={ID_CONTADOR} readOnly={editable} onChangeText={setID_CONTADOR}/>
